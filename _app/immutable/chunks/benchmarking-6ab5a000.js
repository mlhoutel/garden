import{S as y,i as E,s as b,k as u,q as S,a as A,l,m as i,r as _,h as o,c as N,n as k,b as r,E as g,B as m}from"./index-2e2fe841.js";function I(f){let s,t,e,c,a,w=`<code class="language-js"><span class="token comment">/*
...
==========================================
*/</span></code>`;return{c(){s=u("h2"),t=u("a"),e=S("Benchmark demo"),c=A(),a=u("pre"),this.h()},l(n){s=l(n,"H2",{id:!0});var p=i(s);t=l(p,"A",{href:!0});var d=i(t);e=_(d,"Benchmark demo"),d.forEach(o),p.forEach(o),c=N(n),a=l(n,"PRE",{class:!0});var h=i(a);h.forEach(o),this.h()},h(){k(t,"href","#benchmark-demo"),k(s,"id","benchmark-demo"),k(a,"class","language-js")},m(n,p){r(n,s,p),g(s,t),g(t,e),r(n,c,p),r(n,a,p),a.innerHTML=w},p:m,i:m,o:m,d(n){n&&o(s),n&&o(c),n&&o(a)}}}const R={title:"Benchmarking"};class v extends y{constructor(s){super(),E(this,s,null,I,b,{})}}export{v as default,R as metadata};
