import{S as I,i as P,s as R,k,q as X,a as g,l as i,m as r,r as E,h as s,c as x,n as m,b as c,E as h,B as _}from"./index-2e2fe841.js";function T(q){let t,l,w,f,p,W=`<code class="language-js"><span class="token comment">// https://en.wikipedia.org/wiki/Lagrange_polynomial</span>
...
<span class="token constant">TODO</span></code>`;return{c(){t=k("h2"),l=k("a"),w=X("Lagrange"),f=g(),p=k("pre"),d=g(),o=k("h2"),u=k("a"),b=X("Splines"),y=g(),e=k("pre"),this.h()},l(n){t=i(n,"H2",{id:!0});var a=r(t);l=i(a,"A",{href:!0});var j=r(l);w=E(j,"Lagrange"),j.forEach(s),a.forEach(s),f=x(n),p=i(n,"PRE",{class:!0});var A=r(p);A.forEach(s),d=x(n),o=i(n,"H2",{id:!0});var v=r(o);u=i(v,"A",{href:!0});var L=r(u);b=E(L,"Splines"),L.forEach(s),v.forEach(s),y=x(n),e=i(n,"PRE",{class:!0});var H=r(e);H.forEach(s),this.h()},h(){m(l,"href","#lagrange"),m(t,"id","lagrange"),m(p,"class","language-js"),m(u,"href","#splines"),m(o,"id","splines"),m(e,"class","language-js")},m(n,a){c(n,t,a),h(t,l),h(l,w),c(n,f,a),c(n,p,a),p.innerHTML=W,c(n,d,a),c(n,o,a),h(o,u),h(u,b),c(n,y,a),c(n,e,a),e.innerHTML=S},p:_,i:_,o:_,d(n){n&&s(t),n&&s(f),n&&s(p),n&&s(d),n&&s(o),n&&s(y),n&&s(e)}}}const O={title:"Interpolation"};class B extends I{constructor(t){super(),P(this,t,null,T,R,{})}}export{B as default,O as metadata};
