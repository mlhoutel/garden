import{S as I,i as z,s as K,k as o,r as G,a as x,l as c,m as e,u as M,h as s,c as y,p as u,b as p,F as w,n as H}from"./index.73c741f7.mjs";function N(P){let t,b,g,h,l,q=`<code class="language-js"><span class="token comment">// https://en.wikipedia.org/wiki/Gaussian_elimination</span>
...
x = [ 12.0, 5.0, 7.0 ]
*/</span></code>`,A,k,d,E,j,i,D=`<code class="language-js"><span class="token comment">// https://en.wikipedia.org/wiki/Jacobi_method</span>
...
x = [ 2, 2, 2 ]
*/</span></code>`,_,r,f,S,v,m,U=`<code class="language-js"><span class="token comment">// https://en.wikipedia.org/wiki/Gauss%E2%80%93Seidel_method</span>
...
x = [ 12, 5, 7 ]
*/</span></code>`;return{c(){t=o("h2"),b=o("a"),g=G("Gaussian"),h=x(),l=o("pre"),A=x(),k=o("h2"),d=o("a"),E=G("Jacobi"),j=x(),i=o("pre"),_=x(),r=o("h2"),f=o("a"),S=G("Siedel"),v=x(),m=o("pre"),this.h()},l(n){t=c(n,"H2",{id:!0});var a=e(t);b=c(a,"A",{href:!0});var J=e(b);g=M(J,"Gaussian"),J.forEach(s),a.forEach(s),h=y(n),l=c(n,"PRE",{class:!0});var B=e(l);B.forEach(s),A=y(n),k=c(n,"H2",{id:!0});var T=e(k);d=c(T,"A",{href:!0});var R=e(d);E=M(R,"Jacobi"),R.forEach(s),T.forEach(s),j=y(n),i=c(n,"PRE",{class:!0});var C=e(i);C.forEach(s),_=y(n),r=c(n,"H2",{id:!0});var W=e(r);f=c(W,"A",{href:!0});var L=e(f);S=M(L,"Siedel"),L.forEach(s),W.forEach(s),v=y(n),m=c(n,"PRE",{class:!0});var F=e(m);F.forEach(s),this.h()},h(){u(b,"href","#gaussian"),u(t,"id","gaussian"),u(l,"class","language-js"),u(d,"href","#jacobi"),u(k,"id","jacobi"),u(i,"class","language-js"),u(f,"href","#siedel"),u(r,"id","siedel"),u(m,"class","language-js")},m(n,a){p(n,t,a),w(t,b),w(b,g),p(n,h,a),p(n,l,a),l.innerHTML=q,p(n,A,a),p(n,k,a),w(k,d),w(d,E),p(n,j,a),p(n,i,a),i.innerHTML=D,p(n,_,a),p(n,r,a),w(r,f),w(f,S),p(n,v,a),p(n,m,a),m.innerHTML=U},p:H,i:H,o:H,d(n){n&&s(t),n&&s(h),n&&s(l),n&&s(A),n&&s(k),n&&s(j),n&&s(i),n&&s(_),n&&s(r),n&&s(v),n&&s(m)}}}const Q={title:"System",short:"Gaussian elimination, Jacobi method and Gauss-Siedel",topic:"maths system-solving"};class V extends I{constructor(t){super(),z(this,t,null,N,K,{})}}export{V as default,Q as metadata};
