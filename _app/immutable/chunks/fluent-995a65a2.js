import{S as Es,i as Ls,s as Ns,k as t,q as r,a as l,l as o,m as e,r as d,h as n,c as k,n as u,b as p,E as c,B as ss}from"./index-2e2fe841.js";function js(ys){let i,h,V,R,v,N,W,J,m,gs=`<code class="language-java"><span class="token keyword">package</span> <span class="token namespace">windows</span><span class="token punctuation">;</span>
...
<span class="token punctuation">&#125;</span></code>`,H,w,B,X,O,_,j,K,M,y,fs=`<code class="language-java"><span class="token keyword">package</span> <span class="token namespace">windows</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SectionBuilder</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token class-name">T</span><span class="token punctuation">></span></span> <span class="token punctuation">&#123;</span>
	...
	<span class="token keyword">public</span> <span class="token class-name">Section</span> <span class="token function">collect</span><span class="token punctuation">(</span><span class="token class-name">String</span> parentName<span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
		...
		<span class="token keyword">return</span> f<span class="token punctuation">;</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,z,f,T,Y,C,E,x,Z,q,b,Ss=`<code class="language-java"><span class="token keyword">package</span> <span class="token namespace">windows</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Frame</span> <span class="token punctuation">&#123;</span>
	...
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`,U,L,P,$,D,S,hs=`<code class="language-java"><span class="token keyword">package</span> <span class="token namespace">windows</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Section</span> <span class="token punctuation">&#123;</span>
	...
	<span class="token keyword">public</span> <span class="token class-name">String</span> <span class="token function">execute</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">&#123;</span>
		...
		<span class="token keyword">return</span> program<span class="token punctuation">;</span>
	<span class="token punctuation">&#125;</span>
<span class="token punctuation">&#125;</span></code>`;return{c(){i=t("h2"),h=t("a"),V=r("Api use"),R=l(),v=t("p"),N=t("strong"),W=r("Main"),J=l(),m=t("pre"),H=l(),w=t("h2"),B=t("a"),X=r("Builders"),O=l(),_=t("p"),j=t("strong"),K=r("Frame builder"),M=l(),y=t("pre"),G=l(),F=t("p"),A=t("strong"),Q=r("Section builder"),I=l(),g=t("pre"),z=l(),f=t("h2"),T=t("a"),Y=r("Generators objects"),C=l(),E=t("p"),x=t("strong"),Z=r("Frame"),q=l(),b=t("pre"),U=l(),L=t("p"),P=t("strong"),$=r("Section"),D=l(),S=t("pre"),this.h()},l(s){i=o(s,"H2",{id:!0});var a=e(i);h=o(a,"A",{href:!0});var ns=e(h);V=d(ns,"Api use"),ns.forEach(n),a.forEach(n),R=k(s),v=o(s,"P",{});var as=e(v);N=o(as,"STRONG",{});var ps=e(N);W=d(ps,"Main"),ps.forEach(n),as.forEach(n),J=k(s),m=o(s,"PRE",{class:!0});var vs=e(m);vs.forEach(n),H=k(s),w=o(s,"H2",{id:!0});var ts=e(w);B=o(ts,"A",{href:!0});var os=e(B);X=d(os,"Builders"),os.forEach(n),ts.forEach(n),O=k(s),_=o(s,"P",{});var es=e(_);j=o(es,"STRONG",{});var cs=e(j);K=d(cs,"Frame builder"),cs.forEach(n),es.forEach(n),M=k(s),y=o(s,"PRE",{class:!0});var Bs=e(y);Bs.forEach(n),G=k(s),F=o(s,"P",{});var ls=e(F);A=o(ls,"STRONG",{});var ks=e(A);Q=d(ks,"Section builder"),ks.forEach(n),ls.forEach(n),I=k(s),g=o(s,"PRE",{class:!0});var _s=e(g);_s.forEach(n),z=k(s),f=o(s,"H2",{id:!0});var us=e(f);T=o(us,"A",{href:!0});var is=e(T);Y=d(is,"Generators objects"),is.forEach(n),us.forEach(n),C=k(s),E=o(s,"P",{});var rs=e(E);x=o(rs,"STRONG",{});var ds=e(x);Z=d(ds,"Frame"),ds.forEach(n),rs.forEach(n),q=k(s),b=o(s,"PRE",{class:!0});var Fs=e(b);Fs.forEach(n),U=k(s),L=o(s,"P",{});var ms=e(L);P=o(ms,"STRONG",{});var ws=e(P);$=d(ws,"Section"),ws.forEach(n),ms.forEach(n),D=k(s),S=o(s,"PRE",{class:!0});var Ts=e(S);Ts.forEach(n),this.h()},h(){u(h,"href","#api-use"),u(i,"id","api-use"),u(m,"class","language-java"),u(B,"href","#builders"),u(w,"id","builders"),u(y,"class","language-java"),u(g,"class","language-java"),u(T,"href","#generators-objects"),u(f,"id","generators-objects"),u(b,"class","language-java"),u(S,"class","language-java")},m(s,a){p(s,i,a),c(i,h),c(h,V),p(s,R,a),p(s,v,a),c(v,N),c(N,W),p(s,J,a),p(s,m,a),m.innerHTML=gs,p(s,H,a),p(s,w,a),c(w,B),c(B,X),p(s,O,a),p(s,_,a),c(_,j),c(j,K),p(s,M,a),p(s,y,a),y.innerHTML=fs,p(s,G,a),p(s,F,a),c(F,A),c(A,Q),p(s,I,a),p(s,g,a),g.innerHTML=bs,p(s,z,a),p(s,f,a),c(f,T),c(T,Y),p(s,C,a),p(s,E,a),c(E,x),c(x,Z),p(s,q,a),p(s,b,a),b.innerHTML=Ss,p(s,U,a),p(s,L,a),c(L,P),c(P,$),p(s,D,a),p(s,S,a),S.innerHTML=hs},p:ss,i:ss,o:ss,d(s){s&&n(i),s&&n(R),s&&n(v),s&&n(J),s&&n(m),s&&n(H),s&&n(w),s&&n(O),s&&n(_),s&&n(M),s&&n(y),s&&n(G),s&&n(F),s&&n(I),s&&n(g),s&&n(z),s&&n(f),s&&n(C),s&&n(E),s&&n(q),s&&n(b),s&&n(U),s&&n(L),s&&n(D),s&&n(S)}}}const xs={title:"Fluent Api",short:"",latex:!1};class Ps extends Es{constructor(i){super(),Ls(this,i,null,js,Ns,{})}}export{Ps as default,xs as metadata};
