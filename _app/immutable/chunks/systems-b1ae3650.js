import{S as z,i as F,s as K,k as o,q as S,a as x,l as c,m as e,r as G,h as s,c as y,n as u,b as p,E as w,B as H}from"./index-2e2fe841.js";function N(L){let t,b,g,h,l,P=`<code class="language-js"><span class="token comment">// https://en.wikipedia.org/wiki/Gaussian_elimination</span>
...
x = [ 12.0, 5.0, 7.0 ]
*/</span></code>`,A,k,f,E,j,i,B=`<code class="language-js"><span class="token comment">// https://en.wikipedia.org/wiki/Jacobi_method</span>
...
x = [ 2, 2, 2 ]
*/</span></code>`,_,r,d,M,v,m,D=`<code class="language-js"><span class="token comment">// https://en.wikipedia.org/wiki/Gauss%E2%80%93Seidel_method</span>
...
x = [ 12, 5, 7 ]
*/</span></code>`;return{c(){t=o("h2"),b=o("a"),g=S("Gaussian"),h=x(),l=o("pre"),A=x(),k=o("h2"),f=o("a"),E=S("Jacobi"),j=x(),i=o("pre"),_=x(),r=o("h2"),d=o("a"),M=S("Siedel"),v=x(),m=o("pre"),this.h()},l(n){t=c(n,"H2",{id:!0});var a=e(t);b=c(a,"A",{href:!0});var T=e(b);g=G(T,"Gaussian"),T.forEach(s),a.forEach(s),h=y(n),l=c(n,"PRE",{class:!0});var U=e(l);U.forEach(s),A=y(n),k=c(n,"H2",{id:!0});var J=e(k);f=c(J,"A",{href:!0});var R=e(f);E=G(R,"Jacobi"),R.forEach(s),J.forEach(s),j=y(n),i=c(n,"PRE",{class:!0});var C=e(i);C.forEach(s),_=y(n),r=c(n,"H2",{id:!0});var W=e(r);d=c(W,"A",{href:!0});var q=e(d);M=G(q,"Siedel"),q.forEach(s),W.forEach(s),v=y(n),m=c(n,"PRE",{class:!0});var I=e(m);I.forEach(s),this.h()},h(){u(b,"href","#gaussian"),u(t,"id","gaussian"),u(l,"class","language-js"),u(f,"href","#jacobi"),u(k,"id","jacobi"),u(i,"class","language-js"),u(d,"href","#siedel"),u(r,"id","siedel"),u(m,"class","language-js")},m(n,a){p(n,t,a),w(t,b),w(b,g),p(n,h,a),p(n,l,a),l.innerHTML=P,p(n,A,a),p(n,k,a),w(k,f),w(f,E),p(n,j,a),p(n,i,a),i.innerHTML=B,p(n,_,a),p(n,r,a),w(r,d),w(d,M),p(n,v,a),p(n,m,a),m.innerHTML=D},p:H,i:H,o:H,d(n){n&&s(t),n&&s(h),n&&s(l),n&&s(A),n&&s(k),n&&s(j),n&&s(i),n&&s(_),n&&s(r),n&&s(v),n&&s(m)}}}const Q={title:"System"};class V extends z{constructor(t){super(),F(this,t,null,N,K,{})}}export{V as default,Q as metadata};
