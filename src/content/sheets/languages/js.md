...
document.querySelectorAll(
	'.classObject'
); /* To get all items in an array, we use querySelectorAll */
...
document.getElementByClassName(
	'classA classB ...'
); /* We get the array of all elements that have both classes */
...
Cypress.on('window:before:load', function (window) {
	...
	window.EventTarget.prototype.addEventListener = function () {
		if (argument && argument[0] === 'beforeunload') {
			return;
		}
...
_from https://github.com/vercel/pkg/issues/42_
...
_from https://github.com/vercel/pkg#snapshot-filesystem_
...
_from https://github.com/vercel/pkg#bytecode-reproducibility_
...
_from https://github.com/vercel/pkg#other-considerations_
...
_see https://github.com/vercel/pkg/issues/1139_
